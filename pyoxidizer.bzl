...
def make_exe(dist):
    ...
    #     write_modules_directory_env=None,
          run_eval="from dora_dhcp_client.dora import main; main()",
    #     run_module=None,
    #     run_noop=False,
    #     run_repl=True,
    )
    ...
    #    path="/home/lvrf/misc/py_programs/NS1/dhcp_client/dora_dhcp_client",
    #    packages=["dora_dhcp_client"],
    #)

    # Discover Python files from a virtualenv and add them to our embedded
    # context.
    exe.add_python_resources(dist.read_virtualenv(path="/home/lvrf/misc/py_programs/NS1/dhcp_client/venv/"))
